                ...
                <div className="flex items-center gap-2">
                  ...
                  {festival.description && (
                    <span className="relative group">
                      ...
                      <span className="absolute left-0 top-full mt-2 w-72 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg shadow-lg
                        ...
                        <span className="absolute left-4 bottom-full w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-b-[6px] border-b-gray-900" />
                      </span>
                    </span>
                  )}
                </div>
